...
{
    Task<ApiResponse<DoctorCompensationRuleDto>> CreateDoctorCompensationRuleAsync(Guid tenantId, Guid doctorId, CreateDoctorCompensationRuleRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<AttendanceRecordDto>> CreateAttendanceRecordAsync(Guid tenantId, CreateAttendanceRecordRequest request, CancellationToken cancellationToken = default);
