      ...
      <div className='container mx-auto flex h-16 items-center justify-between px-4 md:px-6'>
        ...
        <div className='flex items-center gap-8 md:gap-10'>
          ...
          >
            ...
            <span className='font-bold text-xl text-primary tracking-tight hidden xs:inline-block'>
              {clinic.clinicName}
            </span>
          </Link>
          ...
          <div className='hidden md:flex items-center gap-3'>
            ...
            {mainContact && (
              <Button
                ...
                size='sm'
                asChild
                className='rounded-full h-9 w-9 p-0 border-emerald-500/20 hover:bg-emerald-500/10'
              >
                <a
